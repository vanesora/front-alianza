...
export class ConfigurationService {
  ...
  public menuView = true;
  public menu: any[]  = [
    { text: "Clients", icon: "person", url: "customers" },
    {
      text: "Clients look history", icon: "manage_accounts", url: "customers-history" },
    { text: "Emergency PIN configuration", icon: "emergency", url: "pin" },
    { text: "Emergency PIN history", icon: "e911_emergency", url: "pin-emergency"},
    
  ]
  public selectMenu = { text: "Clients", icon: "person", url: "customers" };

  constructor(
    private snackBar: MatSnackBar,
    private router: Router,
  ) {
    this.menuView = this.screenWidth > 880;
  }
